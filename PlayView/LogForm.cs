...
namespace PolarBearsProgram
{
    public partial class LogForm : Form
    {
        ...
        public void AddRow(string action, string plc,string motor_name,Boolean pause,String direction, int angle_rotation,float accelerate,float deccelerate, int velocity, int duration)
        {
            ...
            if (!File.Exists(path))
            {
                ...
                tw.WriteLine((date + " " + time) + "; " + action + "; PLC:" + plc + "; Motor:" + motor_name + "; Pause:"+ pause +"; Rotation:" + angle_rotation + " degrees "+direction+"\n; Acceleration:"+accelerate+ "m/s²; Decceleration:" + deccelerate+ "m/s²; Velocity: " + velocity+" m/s; Duration: "+duration +"sec");
                tw.Close();
            }
