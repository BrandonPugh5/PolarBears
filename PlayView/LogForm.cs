...
namespace PolarBearsProgram
{
    public partial class LogForm : Form
    {
        ...
        public void AddRow(string action, string plc,string motor_name,Boolean pause,String direction, int angle_rotation,int accelerate,int deccelerate, int velocity, int duration)
        {
